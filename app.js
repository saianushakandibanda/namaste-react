...
const Header = () => {
    return (
        <div className='header' style={{}}>
            <div className='logo'>
                <img className='logo-img' src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png" />
            </div>
...
const RestaurantTile = (props) => {
    ...
    return (
        <div className="res-tile">
            <img className='res-img' src="https://www.wbcsd.org/var/site/storage/images/media/images/fresh_pa/80809-2-eng-GB/FRESH_PA_i1140.jpg"/>
            <h4>{resData.name}</h4>
    ...
    return (
        <div>
            ...
            <div className='res-comp'>
                {
                    restauranttList.map(x => <RestaurantTile resData={x.data} />)
                }
            </div>
        </div>
    )
